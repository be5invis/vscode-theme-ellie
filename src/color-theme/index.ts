...
export default function generateColorTheme(
	...
	const uiColors = {
		...
		"gitDecoration.modifiedResourceForeground": palette.contra[8].hex(),
		"gitDecoration.addedResourceForeground": palette.green[8].hex(),
		"gitDecoration.untrackedResourceForeground": palette.cyan[8].hex(),
		"gitDecoration.deletedResourceForeground": palette.red[8].hex(),
		"gitDecoration.conflictingResourceForeground": palette.magenta[8].hex(),
		...
		"activityBarBadge.background": palette.accent[5].hex(),
		"activityBarBadge.foreground": palette.fg[10].hex(),
		...
		"terminal.ansiYellow": palette.yellow[6].hex(), // Slightly brighter
		...
		"terminal.ansiBrightYellow": palette.yellow[10].hex(), // Slightly brighter
